...
<p align="center">
  ...
  Отсканируйте упаковку лекарства или загрузите инструкцию и получите ответы, основанные на материалах, голосом или текстом.
</p>
...
2. **Нормализует OCR-текст**, сохраняя полезную структуру абзацев
...
- Переключение китайского и английского языков с синхронизацией ответа ИИ и выбора голоса TTS
...
Если в вопросе пользователя встречается настроенное ключевое слово, система фиксирует событие риска и может отправить email-уведомление.
...
```
MedVision-RAG/
├── frontend/                  # Одностраничное веб-приложение Vue 3 CDN
...
В репозитории пока нет файла лицензии. Добавьте явную лицензию до распространения или повторного использования проекта за пределами предусмотренной области.
